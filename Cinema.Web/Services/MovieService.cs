    ...
    public class MovieService
    {
        ...
        public bool PayForTickets(int cartId)
        {
            ...
            try
            {
                ...
                mail.To.Add(emailTo);
                mail.From = new MailAddress("ananiev.stefan@gmail.com");
                mail.Subject = "Confirmation for your order on Movie Store";
                ...
                smtp.Credentials = new System.Net.NetworkCredential("ananiev.stefan@gmail.com", "StevoAe00+");
                smtp.EnableSsl = true;
                smtp.Send(mail);
